    ...
    return (
        <div className={isDarkMode ? 'dark-mode' : ''}>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                        <div className="flex items-center">
                            <h1 className="text-3xl font-bold gradient-text">FaceSwap</h1>
                        </div>
                        <div className="flex items-center">
                            <div className={`navbar-links ${isMenuOpen ? 'active' : ''}`}>
                                <a href="#home" className="gradient-text hover:gradient-text-secondary font-medium px-3 py-2">Home</a>
                                <a href="#swap" className="gradient-text hover:gradient-text-secondary font-medium px-3 py-2">Swap</a>
                                <a href="#features" className="gradient-text hover:gradient-text-secondary font-medium px-3 py-2">Features</a>
                                <a href="#contact" className="gradient-text hover:gradient-text-secondary font-medium px-3 py-2">Contact</a>
                                <a href="#team" className="gradient-text hover:gradient-text-secondary font-medium px-3 py-2">Team</a>
                            </div>
                            <button
                                onClick={toggleTheme}
                            ...
                            >
                                <i className={`fas ${isDarkMode ? 'fa-sun' : 'fa-moon'} text-purple-600`}></i>
                            </button>
                            <button
                                onClick={toggleMenu}
                                ...
                                title="Toggle Menu"
                            >
                                <i className={`fas ${isMenuOpen ? 'fa-times' : 'fa-bars'} text-purple-600`}></i>
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <section id="features" className="py-24 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-4xl sm:text-5xl font-bold text-center mb-16 animate-slide-up gradient-text">
                        Why FaceSwap?
                    </h2>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        <div className="bg-slate-100 p-8 rounded-2xl card-hover animate-slide-up">
                            <i className="fas fa-bolt text-4xl text-purple-600 mb-4"></i>
                        ...
                        <div className="bg-slate-100 p-8 rounded-2xl card-hover animate-slide-up">
                            ...
                            <h3 className="text-2xl font-semibold mb-4 gradient-text">Secure & Private</h3>
                            <p className="text-slate-600">
                                Your files are processed securely and deleted after use.
                            </p>
                        </div>
                        <div className="bg-slate-100 p-8 rounded-2xl card-hover animate-slide-up">
                            <i className="fas fa-video text-4xl text-purple-600 mb-4"></i>
                            <h3 className="text-2xl font-semibold mb-4 gradient-text">Image & Video Support</h3>
                            <p className="text-slate-600">
            ...
            <section id="swap" className="py-24 bg-slate-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-4xl sm:text-5xl font-bold text-center mb-16 animate-slide-up gradient-text">
                    ...
                    <div className="bg-white rounded-3xl shadow-2xl p-8 sm:p-12">
                        <div className="flex justify-center mb-8">
                            ...
                            >
                                Video Swap <span className="beta-label">Beta</span>
                            </button>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-10">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                                <div>
                                    <label className="block text-xl font-semibold mb-4 gradient-text">
                                        Source {activeTab === 'image' ? 'Image' : 'Video'}
                                    </label>
                                    <div className="border-3 border-dashed border-slate-400 rounded-2xl bg-slate-100 upload-box mx-auto">
                                        {(sourceImageFile || sourceVideoFile) ? (
                                            ...
                                            <p className="text-slate-600">Upload {activeTab === 'image' ? 'image' : 'video'} here</p>
                                        )}
                        ...
                        {(resultImage || resultVideo) && (
                            <div className="mt-12 animate-slide-up">
                                <h3 className="text-2xl font-semibold text-center mb-6 gradient-text">Your Face Swap Result</h3>
                                {resultImage && (
                                    <img
                                        src={resultImage}
                                        alt="Swapped Face"
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        <div className="animate-slide-up">
                            ...
                            <p className="text-slate-600"><i className="fas fa-envelope mr-2"></i>pankajgautamprk@gmail.com</p>
                            <p className="text-slate-600"><i className="fas fa-phone mr-2"></i>+1 (800) 123-4567</p>
                            <div className="flex space-x-4 mt-6">
                                <a href="#" className="text-slate-600 hover:text-purple-600"><i className="fab fa-linkedin text-2xl"></i></a>
                                <a href="https://github.com/PankajGautam04" target="_blank" rel="noopener noreferrer" className="text-slate-600 hover:text-purple-600"><i className="fab fa-github text-2xl"></i></a>
                            </div>
                        </div>
                        <div className="bg-slate-100 p-8 rounded-2xl shadow-lg animate-slide-up">
                            <h3 className="text-2xl font-semibold mb-6 gradient-text">Send Us a Message</h3>
                            <div className="space-y-6">
                                <input
                                    type="text"
                                    placeholder="Your Name"
                                    className="w-full p-4 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-600"
                                />
                                <input
                                    type="email"
                                ...
                                ></textarea>
                                <button
                                    className="w-full px-6 py-4 bg-purple-600 text-white rounded-lg hover:bg-purple-700 btn-primary"
                                >
                                    Send Message
                                </button>
                            </div>
            ...
            <section id="team" className="py-24 bg-slate-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                        <div className="bg-white p-8 rounded-2xl card-hover animate-slide-up">
                            <i className="fas fa-user-circle text-4xl text-purple-600 mb-4"></i>
                            <h3 className="text-2xl font-semibold mb-2 gradient-text-secondary">Chandrapal Parmar</h3>
                            <p className="text-slate-600">MCA Student</p>
                        </div>
                        <div className="bg-white p-8 rounded-2xl card-hover animate-slide-up">
                            <i className="fas fa-user-circle text-4xl text-purple-600 mb-4"></i>
                            <h3 className="text-2xl font-semibold mb-2 gradient-text-secondary">Pankaj Gautam</h3>
                            <p className="text-slate-600">MCA Student</p>
                        </div>
                        <div className="bg-white p-8 rounded-2xl card-hover animate-slide-up">
                            <i className="fas fa-user-circle text-4xl text-purple-600 mb-4"></i>
                            <h3 className="text-2xl font-semibold mb-2 gradient-text-secondary">Siddharth Namdev</h3>
                            <p className="text-slate-600">MCA Student</p>
                        </div>
                    </div>
                </div>
            ...
            <footer className="bg-slate-900 text-white py-12">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                        <div>
                            <h3 className="text-2xl font-bold mb-6 gradient-text">FaceSwap</h3>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                <li><a href="#home" className="text-slate-400 hover:text-white">Home</a></li>
                                <li><a href="#swap" className="text-slate-400 hover:text-white">Swap</a></li>
                                ...
                                <li><a href="#team" className="text-slate-400 hover:text-white">Team</a></li>
                            </ul>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div className="flex space-x-4">
                                <a href="#" className="text-slate-400 hover:text-white"><i className="fab fa-linkedin text-2xl"></i></a>
                                <a href="https://github.com/PankajGautam04" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white"><i className="fab fa-github text-2xl"></i></a>
                            </div>
                        </div>
                    </div>
                    <div className="mt-12">
                        <h4 className="text-lg font-semibold mb-4 gradient-text text-center">Disclaimer</h4>
